...
plot [0:][0:] 'nvme:ext4:MWCL:bufferedio.dat' using 1:2 title 'ext4' with lp ps 0.5, 'nvme:ext4_no_jnl:MWCL:bufferedio.dat' using 1:2 title 'ext4_no_jnl' with lp ps 0.5
